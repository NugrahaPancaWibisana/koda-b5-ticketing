...
export default function SignIn() {
  ...
  useEffect(() => {
    if (Object.keys(data).length !== 0) {
      dispatch(userActions.userSignInThunk(data));
    }
  }, [data, dispatch]);
      ...
      >
        ...
        <div className="w-full">
          ...
          <div className="h-2">
            ...
            {state.errors.user && email.isValid && !email.value && (
              <p className="text-sm text-red-600">{state.errors.user}</p>
            )}
          </div>
        </div>
        <div className="w-full">
          ...
          <div className="h-2">
            ...
            {state.errors.user && password.isValid && !password.value && (
              <p className="text-sm text-red-600">{state.errors.user}</p>
            )}
          </div>
        </div>
        ...
        <button
          ...
          className={`h-14 w-full rounded-sm text-white ${
            !isFormValid ? "bg-primary/30 cursor-not-allowed" : "bg-primary"
          }`}
        >
          Login
        </button>
