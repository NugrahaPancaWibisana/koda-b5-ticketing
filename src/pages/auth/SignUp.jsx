...
export default function SignUp() {
  ...
  return (
    <section className='flex flex-col justify-center items-center min-h-dvh py-10'>
      <svg
        className='w-60'
        viewBox='0 0 93 37'
        fill='none'
      ...
      <form
        className='bg-white rounded-lg flex flex-col justify-center items-center gap-6 w-[90%] sm:max-w-120 p-10'
        onSubmit={onSubmitHandler}
      >
        <div className='flex justify-between items-center w-full gap-5'>
          <div className='flex flex-col justify-center items-center gap-2'>
            <p className='w-10 h-10 flex justify-center items-center leading-0 bg-primary rounded-full text-white'>
              1
            </p>
            <p className='w-full'>Fill form</p>
          </div>
          <hr className='border-t border-dashed border-tertiary flex-1' />
          <div className='flex flex-col justify-center items-center gap-2'>
            <p className='w-10 h-10 flex justify-center items-center leading-0 bg-tertiary rounded-full text-white'>
              2
            </p>
            <p>Activate</p>
          </div>
        ...
        <div className='w-full'>
          ...
          <input
            className='w-full h-14 outline-0 border border-tertiary rounded-sm pl-3'
            type='email'
            name='email'
            id='email'
            autoComplete='email'
        ...
        <div className='w-full'>
          ...
          <div className='flex border border-tertiary rounded-sm px-3'>
            <input
              className='w-full h-14 outline-0'
            ...
            >
              {isShow ? (
                <img className='w-5 h-5' src={eyeOpen} alt='eye closed' />
              ) : (
                <img className='w-5 h-5' src={eyeClosed} alt='eye closed' />
              )}
            </button>
          </div>
          <div className='h-2'>
        ...
        <div className='w-full text-tertiary flex justify-center items-center gap-5'>
        ...
        <div className='w-full flex gap-5'>
          <button
            className='w-full h-14 shadow flex justify-center items-center gap-2'
            type='button'
          >
