...
export default function ChooseUsSection() {
  ...
  return (
    <section className="mt-20 flex flex-col items-start justify-start gap-10 text-center md:mt-0 md:text-start">
      <h1 className="text-primary w-full text-lg leading-8 font-bold tracking-[0.75px]">
        WHY CHOOSE US
      </h1>
      ...
      <div className="mt-5 flex flex-col gap-15 md:flex-row">
        {data.map((value, idx) => {
          return (
            <ChooseUsCard
              key={idx}
