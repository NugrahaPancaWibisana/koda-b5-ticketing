...
export default function Navbar() {
  const user = useSelector((state) => state.user.user_active);
  ...
  return (
    <header className='fixed top-0 w-full h-[91px] flex items-center bg-white font-mulish z-10'>
      <nav className='flex justify-between items-center w-full md:px-[30px] lg:px-[130px]'>
        <div className='w-full md:w-fit flex justify-between items-center px-6 md:px-0'>
          <a to='/'>
            <svg
              width='93'
              height='37'
          ...
          <button
            ...
            className='w-6 h-6 p-1 flex flex-col items-end justify-between md:hidden'
          >
            <span
              className={`${
                isOpen ? "transform-[rotate(-45deg)] w-[21px]" : ""
              } block w-4 h-0.5 bg-black origin-top-right transition-all`}
            />
            <span
              className={`${
                isOpen ? "opacity-0" : ""
              } block w-2.5 h-0.5 bg-black transition-all`}
            />
            <span
              className={`${
                isOpen ? "transform-[rotate(45deg)] w-[21px]" : ""
              } block w-4 h-0.5 bg-black origin-bottom-right transition-all`}
            />
          </button>
        </div>
        <div
          ...
          } absolute top-0 -z-20 bg-white pt-[91px] pb-10 px-6 w-4/5 flex flex-col transition-all h-dvh justify-between`}
        >
          <ul className='flex flex-col gap-2'>
            ...
            <li>
              <NavLink className='text-xl font-normal' to='/movie'>
                Movie
              </NavLink>
            </li>
            <li>
          ...
          <ul className='flex w-full gap-3'>
            {Object.keys(user).length === 0 ? (
              <>
                <li className='flex-1'>
                  <NavLink
                    className='block text-center border border-primary text-primary py-3 rounded-lg'
                    to='/signin'
                  >
                    Sign In
                  </NavLink>
              ...
              <li className='relative border flex-1 rounded-lg'>
                <div
                ...
                {dropdown && (
                  <div className='absolute w-full flex flex-col items-start gap-1 left-1/2 -translate-x-1/2 top-0 -translate-y-22 border py-2 px-5 rounded-lg'>
        ...
        <ul className='hidden md:flex md:flex-row gap-2 md:gap-[60px]'>
          <li>
            <NavLink className='text-xl font-normal' to='/'>
              Home
            </NavLink>
        ...
        <ul className='hidden md:flex gap-3 md:gap-3'>
          {Object.keys(user).length === 0 ? (
            <>
              <li>
                <NavLink
                  className='block text-center border border-primary text-primary py-3 rounded-lg md:px-5'
                  to='/signin'
                >
                  Sign In
                </NavLink>
              ...
              <li>
                <NavLink
                  className='block text-center bg-primary text-white py-3 rounded-lg md:px-5'
                  to='/signup'
                >
                  Sign Up
                </NavLink>
            ...
            <li className='relative'>
              ...
              />
              {dropdown && (
                <div className='absolute flex flex-col gap-1 left-1/2 -translate-x-1/2 translate-y-3 border py-2 px-5 rounded-lg'>
                  <NavLink to='#' className='text-lg'>
                    Profile
                  </NavLink>
                  <button
